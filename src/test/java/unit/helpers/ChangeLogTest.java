...
public class ChangeLogTest {
  ...
  @Test
  public void appendsPrivilegesToChangeLog() {
    ChangeLog changeLog = new ChangeLog();
    ...
    changeLog.appendPrivileges("a", privileges1_1, repository1);
    changeLog.appendPrivileges("b", privileges1_2, repository1);
    changeLog.appendPrivileges("a", privileges2_1, repository2);
    changeLog.appendPrivileges("b", privileges2_2, repository2);
  ...
  @Test
  public void appendsRemovedPrivilegesToChangeLog() {
    ChangeLog changeLog = new ChangeLog();
    ...
    changeLog.appendTakenPrivileges("a", privileges1_1, repository1);
    changeLog.appendTakenPrivileges("b", privileges1_2, repository1);
    changeLog.appendTakenPrivileges("a", privileges2_1, repository2);
    changeLog.appendTakenPrivileges("b", privileges2_2, repository2);
